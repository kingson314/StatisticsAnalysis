...
public class EconomicHolidayDao {
	private static EconomicHolidayDao dao = null;
	private Connection con;

	public static EconomicHolidayDao getInstance() {
		if (dao == null)
			dao = new EconomicHolidayDao();
		return dao;
	}

	// 构造
	private EconomicHolidayDao() {
