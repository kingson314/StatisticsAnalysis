...
public class EconomicEventDao {
	private static EconomicEventDao dao = null;
	private Connection con;

	public static EconomicEventDao getInstance() {
		if (dao == null)
			dao = new EconomicEventDao();
		return dao;
	}

	// 构造
	private EconomicEventDao() {
